...
| basins/usgs_03611500_nldi.geojson (398 KB) | NLDI basin trace upstream of USGS-03611500 (Ohio River at Metropolis, IL), comid 1840007, splitCatchment=false, simplified=true; MultiPolygon, 522,879.1 km2 in ESRI:102008, geometry sha256 4d84f947...; monitoring-locations drainage_area 203,000 mi2, contributing_drainage_area null; traced 2026-09-06; regenerate with skills/delineate-basin/scripts/delineate_basin.py --gauge 03611500 (no credentials) | USGS NLDI (api.water.usgs.gov) | US Government public domain |
| basins/usgs_09380000_nldi.geojson (253 KB) | NLDI basin trace upstream of USGS-09380000 (Colorado River at Lees Ferry, AZ), comid 20733845, same parameters; MultiPolygon, 276,443.7 km2; drainage_area 111,800 mi2, contributing null; traced 2026-09-06; regenerate with skills/delineate-basin/scripts/delineate_basin.py --gauge 09380000 | USGS NLDI | US Government public domain |
| basins/usgs_09085000_nldi.geojson (15 KB) | NLDI basin trace upstream of USGS-09085000 (Roaring Fork River at Glenwood Springs, CO), comid 1324997, same parameters; Polygon, 3,767.1 km2; drainage_area 1,453 mi2, contributing null; traced 2026-09-06; regenerate with skills/delineate-basin/scripts/delineate_basin.py --gauge 09085000 | USGS NLDI | US Government public domain |
...
| basins/huc12_capitol_creek.geojson (43 KB) | Watershed Boundary Dataset unit 140100040402 (Capitol Creek, CO), inside the Roaring Fork basin; Polygon, 95.2 km2 in ESRI:102008 against areasqkm 95.15, geometry sha256 7c3cce30...; drains to 140100040403; queried 2026-09-06; regenerate with skills/delineate-basin/scripts/delineate_basin.py --huc 140100040402 --name huc12_capitol_creek. Chosen because it is 23,512 acres, under the OpenET Tier 1 per-request cap of 50,000, so it is the one fixture unit both evapotranspiration products can see | USGS WBD (hydro.nationalmap.gov) | US Government public domain |
| basins/huc12_padre_creek_lake_powell.geojson (59 KB) | Watershed Boundary Dataset unit 140700061004 (Padre Creek-Lake Powell, UT/AZ); Polygon, 104.6 km2 in ESRI:102008, geometry sha256 68f891fa...; drains to 140700061007; queried 2026-09-06; regenerate with skills/delineate-basin/scripts/delineate_basin.py --huc 140700061004 --name huc12_padre_creek_lake_powell. Chosen because half of it is reservoir: 242 of the 489 MOD16 cells inside it carry the water fill code and 14 more carry barren | USGS WBD (hydro.nationalmap.gov) | US Government public domain |
...
| water-balance/ohio-olmsted-groundwater/ (6 files, 1.96 MB; groundwater.json 1.42 MB) | the Ohio at Olmsted water-balance tree with the groundwater term: basin.geojson, precipitation.json, evapotranspiration.json, discharge.json and storage.json copied byte for byte from water-balance/ohio-olmsted (their manifest entries carry `copied_from`), plus groundwater.json, the well set behind the water-table fluctuation term for water year 2023: 58 continuously recorded USGS wells inside the polygon whose site file says unconfined (aquifer_type_code U) with a constructed depth stated, each with its daily mean depth to water (parameter 72019, statistic 00003, feet below land surface) over 2022-10-01 to 2023-09-30, read out of six usgs-dv captures taken 2026-09-15 with core's obs_capture.py (capture ids 20260915T175104Z-547c91be, 175109Z-b7965a41, 175113Z-06f456bd, 175118Z-4c430c43, 175123Z-37c2a0d8 and 175128Z-918c385c, 54,230 rows over all statistics; the content hashes are in the file), the well's site file from the monitoring-locations collection (aquifer and national aquifer codes, constructed and hole depth, altitude and its datum; the API serves no screened interval), the selection performed and recorded by the freezing script (490 daily 72019 series in the polygon's bounding box, 249 wells covering the window, 141 inside the polygon of which 62 unconfined, 34 confined, 3 mixed, 1 other and 41 with no aquifer type code, 4 unconfined wells without a constructed depth listed by site, 58 selected, read 2026-09-15; the captured set is refused if it is not the selected set), and the parameters the executor binds: specific yield 0.21 plus or minus 0.03 with its source (Gehman and others 2009, DOI 10.1029/2007WR006096, the Crossref abstract; bracketed by Pool and Eychaner 1995, DOI 10.1111/j.1745-6584.1995.tb00299.x; the compilation Johnson 1967, DOI 10.3133/wsp1662D, cited on its registry record), 30-day end windows, 20 days per end, a 2 km clustering radius and 3 sites minimum. Frozen 2026-09-15; regenerate with water-balance/freeze_groundwater_term.py --select, the captures over its list, then the script again | USGS Water Data API (daily, monitoring-locations and time-series-metadata collections), through core's capture tool | US Government public domain |
...
- basin_water_balance, the groundwater term (measured 2026-09-15 at
  fixture creation, on the ohio-olmsted-groundwater tree): of the 58
  wells frozen, 50 pass the completeness rule (8 have fewer than 20
  daily values in an end window), clustering at 2 km gives 39 sites
  with the Louisville well field of 12 wells as one site; the rise
  between the mean depth over 2022-10-01 to 2022-10-30 and over
  2023-09-01 to 2023-09-30 averages +0.0886 m over sites (median
  -0.0631, spread 0.8463, standard error 0.1355, range -1.530 to
  +3.338); at a specific yield of 0.21 +- 0.03 over 524,136 km2 the
  groundwater part of dS is +9.752 +- 14.982 km3 (18.6 mm; 8.359 at
  0.18 and 11.145 at 0.24), against a mascon dS of +1.183 +- 5.103,
  so dS_other is -8.569 +- 15.827 and the terms less groundwater
  +61.605 km3; the residual +70.174 +- 96.874 is unchanged from the
  ohio-olmsted tree and no fraction of dS is reported because dS is
  within two sigma of zero. Bar three: |dS_gw| 9.752 against |dS| + k
  sigma 32.836 km3. The sigma's components are 14.914 km3 from the
  standard error and 1.393 from the specific yield; at the spread over
  sites it would be 93.161 km3; without the largest site (Louisville,
  12 wells, +3.338 m) the mean over the other 38 sites is +0.0031 m and
  the term +0.339 km3.
